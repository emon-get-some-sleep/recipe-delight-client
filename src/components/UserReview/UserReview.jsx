         ...
         <img
          ...
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div className="text-white">
                ...
                <p className="mx-auto w-[56%] text-center mt-4">The food was absolutely amazing! Every bite was bursting with flavor and cooked to perfection. I highly recommend this restaurant to anyone looking for an unforgettable dining experience.</p>
        ...
        <div id="slide2" className="carousel-item review-two relative w-full">
          ...
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div className="text-white">
                ...
                <p className="mx-auto w-[56%] text-center mt-4">I couldn't have asked for a better meal! From the appetizers to the dessert, every dish was impeccably crafted with the freshest ingredients and expertly balanced flavors. The service was also top-notch, making for a truly delightful evening..</p>
        ...
        <div id="slide3" className="carousel-item review-three relative w-full">
          ...
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div className="text-white">
                ...
                <p className="mx-auto w-[56%] text-center mt-4">The food at this restaurant is simply outstanding. The dishes were creative, beautifully presented, and tasted as good as they looked. The staff were friendly and attentive, making for a memorable dining experience. I will definitely be returning!.</p>
